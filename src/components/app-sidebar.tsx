...
const allMainItems = [
  { title: "Dashboard", url: "/", icon: Home, roles: [UserRole.ADMIN, UserRole.MANAGER, UserRole.USER] },
  { title: "Projetos", url: "/projetos", icon: Kanban, roles: [UserRole.ADMIN, UserRole.MANAGER, UserRole.USER] },
  { title: "Funil de Vendas", url: "/funil", icon: TrendingUp, roles: [UserRole.ADMIN, UserRole.MANAGER, UserRole.USER] },
  { title: "CRM", url: "/crm", icon: Users, roles: [UserRole.ADMIN, UserRole.MANAGER, UserRole.USER] },
  { title: "Financeiro", url: "/financeiro", icon: DollarSign, roles: [UserRole.ADMIN] },
]

const allSystemItems = [
  { title: "Configurações", url: "/configuracoes", icon: Settings, roles: [UserRole.ADMIN] },
  { title: "Gestão de Usuários", url: "/gestao-usuarios", icon: UserPlus, roles: [UserRole.ADMIN] },
  { title: "Notificações", url: "/notificacoes", icon: Bell, roles: [UserRole.ADMIN, UserRole.MANAGER, UserRole.USER] },
]
